...
/*   Updated: 2025/08/27 17:40:16 by cfleuret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/cub3d.h"

static double	ray_vert(t_data *data, double cos_a, double sin_a)
{
	double	y_vert;
	double	x_vert;
	double	delta_depth;
...
static double	ray_hori(t_data *data, double cos_a, double sin_a)
{
	double	y_hori;
	double	x_hori;
	double	delta_depth;
...
void	ray_cast(t_data *data)
{
	...
	while (i < data->num_rays)
	{
		cos_a = cos(ray_angle);
		sin_a = sin(ray_angle);
		depth_vert = ray_vert(data, cos_a, sin_a);
		depth_hori = ray_hori(data, cos_a, sin_a);
